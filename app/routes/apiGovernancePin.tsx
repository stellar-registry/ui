...
// transaction (anti-spam gate only — doesn't check it's a `create_proposal`
// call or that the source account exists on-chain), recomputes the CAR's
// root CID independently, and forwards it to Filebase.
//
